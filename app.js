...
const SCRIPTURES = [
  {ref:"Joshua 1:9",kjv:"Have not I commanded thee? Be strong and of a good courage; be not afraid, neither be thou dismayed.",focus:"Train with courage. Do the next faithful thing well."},
  {ref:"Psalm 18:32",kjv:"It is God that girdeth me with strength, and maketh my way perfect.",focus:"Strength is stewardship. Use it well."},
  {ref:"Psalm 18:34",kjv:"He teacheth my hands to war, so that a bow of steel is broken by mine arms.",focus:"Skill is built through patient practice."},
  {ref:"Isaiah 40:31",kjv:"But they that wait upon the LORD shall renew their strength; they shall mount up with wings as eagles.",focus:"Do not confuse patience with passivity."},
  {ref:"1 Corinthians 9:24",kjv:"So run, that ye may obtain.",focus:"Train with purpose, not vanity."},
  {ref:"1 Corinthians 9:27",kjv:"But I keep under my body, and bring it into subjection.",focus:"Discipline your body without making it your master."},
  {ref:"2 Timothy 1:7",kjv:"For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind.",focus:"Power with love. Intensity with a sound mind."},
  {ref:"Philippians 4:13",kjv:"I can do all things through Christ which strengtheneth me.",focus:"Let strength point beyond yourself."},
  {ref:"Proverbs 27:17",kjv:"Iron sharpeneth iron; so a man sharpeneth the countenance of his friend.",focus:"Let training make you more useful to the men around you."},
  {ref:"Micah 6:8",kjv:"Do justly, and to love mercy, and to walk humbly with thy God.",focus:"Strength without humility misses the point."},
  {ref:"Colossians 3:23",kjv:"And whatsoever ye do, do it heartily, as to the Lord, and not unto men.",focus:"Make the quality of the work an act of worship."},
  {ref:"Psalm 144:1",kjv:"Blessed be the LORD my strength, which teacheth my hands to war, and my fingers to fight.",focus:"Learn the skill. Respect the responsibility that comes with it."}
];
// Scripture is King James Version: public domain, no license or notice to maintain as the verse set grows.
const TRANSLATIONS={kjv:"KJV"};
function bibleVersion(){ return 'kjv'; }
function verseText(v){ return v.kjv; }
