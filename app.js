...
const SCRIPTURES = [
  {ref:"Joshua 1:9",kjv:"Have not I commanded thee? Be strong and of a good courage; be not afraid, neither be thou dismayed.",esv:"Be strong and courageous. Do not be frightened, and do not be dismayed, for the LORD your God is with you wherever you go.",focus:"Train with courage. Do the next faithful thing well."},
  {ref:"Psalm 18:32",kjv:"It is God that girdeth me with strength, and maketh my way perfect.",esv:"The God who equipped me with strength and made my way blameless.",focus:"Strength is stewardship. Use it well."},
  {ref:"Psalm 18:34",kjv:"He teacheth my hands to war, so that a bow of steel is broken by mine arms.",esv:"He trains my hands for war, so that my arms can bend a bow of bronze.",focus:"Skill is built through patient practice."},
  {ref:"Isaiah 40:31",kjv:"But they that wait upon the LORD shall renew their strength; they shall mount up with wings as eagles.",esv:"They who wait for the LORD shall renew their strength; they shall mount up with wings like eagles; they shall run and not be weary; they shall walk and not faint.",focus:"Do not confuse patience with passivity."},
  {ref:"1 Corinthians 9:24",kjv:"So run, that ye may obtain.",esv:"Do you not know that in a race all the runners run, but only one receives the prize? So run that you may obtain it.",focus:"Train with purpose, not vanity."},
  {ref:"1 Corinthians 9:27",kjv:"But I keep under my body, and bring it into subjection.",esv:"But I discipline my body and keep it under control, lest after preaching to others I myself should be disqualified.",focus:"Discipline your body without making it your master."},
  {ref:"2 Timothy 1:7",kjv:"For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind.",esv:"For God gave us a spirit not of fear but of power and love and self-control.",focus:"Power with love. Intensity with a sound mind."},
  {ref:"Philippians 4:13",kjv:"I can do all things through Christ which strengtheneth me.",esv:"I can do all things through him who strengthens me.",focus:"Let strength point beyond yourself."},
  {ref:"Proverbs 27:17",kjv:"Iron sharpeneth iron; so a man sharpeneth the countenance of his friend.",esv:"Iron sharpens iron, and one man sharpens another.",focus:"Let training make you more useful to the men around you."},
  {ref:"Micah 6:8",kjv:"Do justly, and to love mercy, and to walk humbly with thy God.",esv:"He has told you, O man, what is good; and what does the LORD require of you but to do justice, and to love kindness, and to walk humbly with your God?",focus:"Strength without humility misses the point."},
  {ref:"Colossians 3:23",kjv:"And whatsoever ye do, do it heartily, as to the Lord, and not unto men.",esv:"Whatever you do, work heartily, as for the Lord and not for men.",focus:"Make the quality of the work an act of worship."},
  {ref:"Psalm 144:1",kjv:"Blessed be the LORD my strength, which teacheth my hands to war, and my fingers to fight.",esv:"Blessed be the LORD, my rock, who trains my hands for war, and my fingers for battle.",focus:"Learn the skill. Respect the responsibility that comes with it."}
];
const TRANSLATIONS={esv:"ESV",kjv:"KJV"};
const ESV_NOTICE="Scripture quotations marked ESV are from The ESV® Bible (The Holy Bible, English Standard Version®), © 2001 by Crossway, a publishing ministry of Good News Publishers. Used by permission. All rights reserved.";
function bibleVersion(){ const v=getState().settings.bible; return TRANSLATIONS[v]?v:'esv'; }
function verseText(v){ return v[bibleVersion()]||v.esv; }
