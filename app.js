...
function phaseScene(phase){ const c=SCENES[phase]||SCENES.none; const [a,b,c3,d,e]=c.sky;
  return `<svg viewBox="0 0 375 420" preserveAspectRatio="xMidYMid slice" aria-hidden="true"><defs><linearGradient id="hrSky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="${a}"/><stop offset=".4" stop-color="${b}"/><stop offset=".58" stop-color="${c3}"/><stop offset=".68" stop-color="${d}"/><stop offset=".8" stop-color="${e}"/><stop offset="1" stop-color="#0b100d"/></linearGradient><radialGradient id="hrSun" cx="50%" cy="50%" r="50%"><stop offset="0" stop-color="#fff4d0"/><stop offset=".45" stop-color="${c.sun}" stop-opacity=".95"/><stop offset="1" stop-color="${c.sun}" stop-opacity="0"/></radialGradient><linearGradient id="hrFog" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#e9c48a" stop-opacity="0"/><stop offset="1" stop-color="#e9c48a" stop-opacity=".45"/></linearGradient></defs><rect width="375" height="420" fill="url(#hrSky)"/><circle cx="240" cy="272" r="62" fill="url(#hrSun)"/><path d="M0 300 L55 245 L110 280 L180 205 L235 268 L295 220 L375 280 L375 420 L0 420Z" fill="${c.ridge1}"/><path d="M0 338 L55 303 L125 338 L195 283 L255 323 L325 293 L375 333 L375 420 L0 420Z" fill="${c.ridge2}"/><rect x="0" y="296" width="375" height="60" fill="url(#hrFog)"/><path d="M0 385 C80 360 140 405 220 375 C290 350 330 375 375 365 L375 420 L0 420Z" fill="#0b120e"/><g fill="#080d0a"><path d="M40 410 l6-40 6 40z M52 414 l5-30 5 30z M300 402 l7-46 7 46z M318 410 l5-32 5 32z"/></g></svg>`; }
